 ...
 * @date : 14/12/15 : 11:57 PM
 * @email : kaustubh@betacraft.co
 */
public class GridAdapter extends BaseAdapter {

    private List<FacebookPhoto> mData;
    ...
    public void setData(final ArrayList<FacebookPhoto> list){
        mData = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(parent.getContext()).load(getItem(position).getLink())
